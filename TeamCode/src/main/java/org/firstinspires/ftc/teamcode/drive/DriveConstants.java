...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 13.30; // in
     ...
     * empirically tuned.
     */
    public static double kV = 1.10 / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = Math.toRadians(214.81936137716485);
